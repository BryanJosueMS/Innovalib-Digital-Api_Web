    ...
    public partial class Bitacora : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    // Cargar la bitácora de transacciones al cargar la página
                    CargarBitacoraTransacciones();
                }
                else
                {
        ...
        /// <summary>
        /// Carga los datos de la bitácora de transacciones en el GridView.
        /// </summary>
        private void CargarBitacoraTransacciones()
        {
            try
            {
                // Obtener todos los registros de la tabla BitacoraTransacciones
                gvBitacora.DataSource = entities.BitacoraTransacciones.ToList();
                gvBitacora.DataBind();
            ...
            catch (Exception ex)
            {
                ...
                // Registrar el error en la bitácora de errores (si el método existe)
