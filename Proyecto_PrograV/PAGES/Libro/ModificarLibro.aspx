<%@ Page Title="Actualizar Libro" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModificarLibro.aspx.cs" Inherits="Proyecto_PrograV.PAGES.Libro.ActualizarLibro" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="display: flex; justify-content: space-between; align-items: center; padding: 20px;">
        <h2 style="margin: 0;">Actualizar Libro</h2>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <asp:TextBox ID="txtUnidadesDisponibles" runat="server" CssClass="form-control" TextMode="Number" min="1"></asp:TextBox>
